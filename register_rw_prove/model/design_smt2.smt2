...
(define-fun |register_rw#14| ((state |register_rw_s|)) Bool (|register_rw_is| state)) ; $0$formal$register_rw.v:37$9_EN[0:0]$59
; yosys-smt2-assume 0 register_rw.v:37.9-37.21
(define-fun |register_rw_u 0| ((state |register_rw_s|)) Bool (or (|register_rw#1| state) (not (|register_rw#14| state)))) ; $assume$register_rw.v:37$53
; yosys-smt2-anyseq register_rw#15 1 $auto$setundef.cc:501:execute$117
(declare-fun |register_rw#15| (|register_rw_s|) (_ BitVec 1)) ; $auto$rtlil.cc:2817:Anyseq$118
; yosys-smt2-anyseq register_rw#16 1 $auto$setundef.cc:501:execute$115
(declare-fun |register_rw#16| (|register_rw_s|) (_ BitVec 1)) ; $auto$rtlil.cc:2817:Anyseq$116
(define-fun |register_rw#17| ((state |register_rw_s|)) Bool (= (|register_rw#3| state) (|register_rw#6| state))) ; $eq$register_rw.v:53$46_Y
(define-fun |register_rw#18| ((state |register_rw_s|)) Bool (not (or  (|register_rw#0| state) false))) ; $logic_not$register_rw.v:52$42_Y
(define-fun |register_rw#19| ((state |register_rw_s|)) Bool (and (or  (= ((_ extract 0 0) (|register_rw#7| state)) #b1) false) (or  (|register_rw#18| state) false))) ; $logic_and$register_rw.v:52$43_Y
(define-fun |register_rw#20| ((state |register_rw_s|)) Bool (not (or  (= ((_ extract 0 0) (|register_rw#8| state)) #b1) false))) ; $logic_not$register_rw.v:48$38_Y
(define-fun |register_rw#21| ((state |register_rw_s|)) Bool (and (or  (|register_rw#19| state) false) (or  (|register_rw#20| state) false))) ; $logic_and$register_rw.v:52$45_Y
(define-fun |register_rw#22| ((state |register_rw_s|)) (_ BitVec 1) (ite (|register_rw#21| state) (ite (|register_rw#17| state) #b1 #b0) (|register_rw#16| state))) ; $procmux$80_Y
(define-fun |register_rw#23| ((state |register_rw_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|register_rw#2| state)) #b1) (|register_rw#22| state) (|register_rw#15| state))) ; $0$formal$register_rw.v:53$13_CHECK[0:0]$29
(define-fun |register_rw#24| ((state |register_rw_s|)) (_ BitVec 1) (ite (|register_rw#21| state) #b1 #b0)) ; $procmux$76_Y
(define-fun |register_rw#25| ((state |register_rw_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|register_rw#2| state)) #b1) (|register_rw#24| state) #b0)) ; $auto$rtlil.cc:2224:Mux$132
; yosys-smt2-anyseq register_rw#26 1 $auto$setundef.cc:501:execute$121
(declare-fun |register_rw#26| (|register_rw_s|) (_ BitVec 1)) ; $auto$rtlil.cc:2817:Anyseq$122
; yosys-smt2-anyseq register_rw#27 1 $auto$setundef.cc:501:execute$119
(declare-fun |register_rw#27| (|register_rw_s|) (_ BitVec 1)) ; $auto$rtlil.cc:2817:Anyseq$120
(define-fun |register_rw#28| ((state |register_rw_s|)) Bool (= (|register_rw#3| state) (|register_rw#9| state))) ; $eq$register_rw.v:57$52_Y
(define-fun |register_rw#29| ((state |register_rw_s|)) Bool (not (or  (= ((_ extract 0 0) (|register_rw#7| state)) #b1) false))) ; $logic_not$register_rw.v:56$47_Y
(define-fun |register_rw#30| ((state |register_rw_s|)) Bool (and (or  (|register_rw#29| state) false) (or  (|register_rw#18| state) false))) ; $logic_and$register_rw.v:56$49_Y
(define-fun |register_rw#31| ((state |register_rw_s|)) Bool (and (or  (|register_rw#30| state) false) (or  (|register_rw#20| state) false))) ; $logic_and$register_rw.v:56$51_Y
(define-fun |register_rw#32| ((state |register_rw_s|)) (_ BitVec 1) (ite (|register_rw#31| state) (ite (|register_rw#28| state) #b1 #b0) (|register_rw#27| state))) ; $procmux$88_Y
(define-fun |register_rw#33| ((state |register_rw_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|register_rw#2| state)) #b1) (|register_rw#32| state) (|register_rw#26| state))) ; $0$formal$register_rw.v:57$14_CHECK[0:0]$31
(define-fun |register_rw#34| ((state |register_rw_s|)) (_ BitVec 1) (ite (|register_rw#31| state) #b1 #b0)) ; $procmux$84_Y
(define-fun |register_rw#35| ((state |register_rw_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|register_rw#2| state)) #b1) (|register_rw#34| state) #b0)) ; $auto$rtlil.cc:2224:Mux$134
(define-fun |register_rw#36| ((state |register_rw_s|)) (_ BitVec 32) (ite (|register_rw#0| state) (|register_rw#4| state) (|register_rw#3| state))) ; $auto$rtlil.cc:2224:Mux$128
(define-fun |register_rw#37| ((state |register_rw_s|)) (_ BitVec 32) (ite (|register_rw#1| state) #b00000000000000000000000000000000 (|register_rw#36| state))) ; $auto$rtlil.cc:2224:Mux$130
...
(define-fun |register_rw_t| ((state |register_rw_s|) (next_state |register_rw_s|)) Bool (and
  (= (|register_rw#23| state) (|register_rw#13| next_state)) ; $procdff$110 $formal$register_rw.v:53$13_CHECK
  (= (|register_rw#25| state) (|register_rw#12| next_state)) ; $auto$opt_dff.cc:702:run$126 $formal$register_rw.v:53$13_EN
  (= (|register_rw#33| state) (|register_rw#11| next_state)) ; $procdff$112 $formal$register_rw.v:57$14_CHECK
  (= (|register_rw#35| state) (|register_rw#10| next_state)) ; $auto$opt_dff.cc:702:run$125 $formal$register_rw.v:57$14_EN
  ...
  (= (|register_rw#37| state) (|register_rw#3| next_state)) ; $auto$opt_dff.cc:764:run$124 \dffreg
